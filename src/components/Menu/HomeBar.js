			...
			<Container>
				<Grid mb={{md:2,sm:1}} mt={{md:2,sm:1}} container sx={{height:"auto"}} alignItems="center">
					<Grid item container md={1} xs={2} justifyContent="center">
						<Tooltip title="Account settings">
							<IconButton
								...
								>
								<Avatar sx={{ width: 40, height: 40, backgroundColor:"rgb(240, 240, 240)", color:"black", fontSize:18, fontWeight:"bold" }}>DG</Avatar>
							</IconButton>
        				</Tooltip>
					</Grid>
					<Menu
					...
					<Grid container item md={3} xs={10}>
						<Typography fontSize={{lg:25, md:20, sm:25, xs:20}} fontWeight="bold">Welcome Damian!</Typography>
					</Grid>
					<Grid item md/>
